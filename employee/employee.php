...
<html> 
    ...
    <body id="body-color">
        <br></br>
			...
			<div class= "formdiv">
				<form action="../addPerfume2.php" method="post"  enctype="multipart/form-data" >  
...
<html> 
    ...
    <body id="body-color">
        <br></br>
			...
			<div class= "formdiv">
				<form action="../updatePerfume2.php" method="post"  enctype="multipart/form-data" >  
						<label for="pid"><b> Perfume ID: </b> </label>
						<input type="text" name="pid" id="pid" maxlength="5" placeholder="5001">
					<br></br>
						<label for="pd"><b> Description: </b></label>
...
<html>     
    <body id="body-color">
        <br></br>
			...
			<div class= "formdiv">
				<form action="../viewTransactionHistory.php" method="post"  enctype="multipart/form-data" >  			
...
<html>  
    <body id="body-color">
        <br></br>
			...
			<div class= "formdiv">
				<form action="../deleteTransaction.php" method="post"  enctype="multipart/form-data" >  
